...
class MainWindow(QTabWidget):
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        self.right_img.setPixmap(QPixmap("images/UI/next.jpeg"))
        ...
        self.setTabIcon(0, QIcon('images/UI/HPU.png'))
        self.setTabIcon(1, QIcon('images/UI/HPU.png'))
        # self.setTabIcon(2, QIcon('images/UI/HPU.png'))
