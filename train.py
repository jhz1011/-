...
# python train.py --data fire_data.yaml --cfg fire_yolov5s.yaml --weights pretrained/yolov5s.pt --epoch 100 --batch-size 8 --device cuda:0
# python train.py --data fire_data.yaml --cfg fire_yolov5l.yaml --weights pretrained/yolov5l.pt --epoch 100 --batch-size 2 --device cuda:0
# python train.py --data fire_data.yaml --cfg fire_yolov5m.yaml --weights pretrained/yolov5m.pt --epoch 100 --batch-size 2 --device cuda:0
